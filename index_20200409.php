...
<head>
    ...
    <title>Tuyển sinh lập trình viên quốc tế Aptech 2020 - Hệ thống lập trình viên quốc tế</title>

    <!-- <link rel="preload" href="dist/style.css<?php echo $version; ?>" as="style" onload="this.rel='stylesheet'" type="text/css" /> -->
    <link rel="preload" href="dist/style.min.css<?php echo $version; ?>" as="style" onload="this.rel='stylesheet'" type="text/css" />
    ...
    <noscript>
        <link rel="stylesheet" href="dist/style.min.css<?php echo $version; ?>" type="text/css" />
...
<body>
    ...
    <!-- Main Content -->
    <!-- <section id="section-banner" class="page-section bg-success">
        <div class="container d-block">
            <div class="row">
                <div class="col-lg-8 offset-lg-4 banner-content">
                    <div class="text-center mb-4">
                        <img src="./img/banner-text-min.png" class="mw-100">
                    </div>
                    <div class="text-center banner-text mb-4 d-flex align-items-center justify-content-center">
                        <div id="bannerTyping"></div>
                    </div>
                    <div class="text-center mb-5">
                        <img src="./img/banner-text-2-min.png" class="mw-100">
                    </div>
                    <div class="text-center">
                        <img src="./img/img-quatang-min.png?v1" class="mw-100">
                    </div>
                </div>
            </div>
        </div>
        <div class="banner-sm d-none d-lg-none">
            <img src="./img/banner-sm-min.png" class="mw-100">
        </div>
    </section> -->
    ...
    <script type="text/javascript" src="dist/script.min.js<?php echo $version; ?>" async></script>
    <!-- <script type="text/javascript" src="dist/script.js<?php echo $version; ?>" async></script> -->
