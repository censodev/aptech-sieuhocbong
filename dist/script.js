...
(function(root, factory) {
  ...
  Circles.prototype = {
    ...
    _generateSvg: function() {
      ...
      this._generatePath(100, false, this._colors[0], this._maxValClass, 0)._generatePath(1, true, this._colors[1], this._valClass, 1);
    ...
    _generatePath: function(percentage, open, color, pathClass, pixel) {
      var path = document.createElementNS('http://www.w3.org/2000/svg', 'path');
      path.setAttribute('fill', 'transparent');
      path.setAttribute('stroke', color);
      path.setAttribute('stroke-width', this._strokeWidth + pixel);
